...
SPR_pc_dash = pygame.image.load('assets/player/mc_dash.png')
...
SPR_projectile_50cal = pygame.image.load('assets/ammo/50cal.png')
    ...
    # Init Pygame #
pygame.display.set_icon(SPR_weapon_pistol_pickup)
pygame.init()
...
class Sprite:
    ...
    def __init__(self, owner, spr, xOffset=0, yOffset=0, width=0, height=0):
        self.owner = owner
        self.sprite = spr
        self.visible = True
        self.setDimensions(xOffset, yOffset, width, height)
    ...
    def draw(self, *args):
        ...
        offsetx = cam.x
        offsety = cam.y
        window.sprite( self, x - offsetx, y - offsety, depth )
...
class BoxCollider:
    ...
    def __init__(self, owner=None, width=0, height=0, xpos=0, ypos=0):
...
class Player(Entity, Mobile):
    ...
    def __init__(self):
        ...
        self.sprite_dash   = Sprite(self, SPR_pc_dash, 16, 16, 32, 32)
    ...
    def dash(self, mov):
        ...
        self.sprite_current = self.sprite_dash
